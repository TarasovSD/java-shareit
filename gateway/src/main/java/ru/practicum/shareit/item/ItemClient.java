...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItemsListByUserId(Long userId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getItemsListBySearch(String text, Integer from, Integer size, Long userId) {
        Map<String, java.lang.Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
